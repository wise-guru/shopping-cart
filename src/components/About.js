...
function About() {
  return (
    <main className="about-container">
      <div className="about">
        <h1 className="about-title content">About us</h1>
        ...
        <div className="text content">
          ...
          <p>
            ...
            sewing, mold making, wood working, laser cutter, and whatever else
            she can get her hands on. Follow along to see what gets built next!
          </p>
        </div>
      </div>
    </main>
